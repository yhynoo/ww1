...
static const float COLORMAP_MUD_OVERLAY_STRENGTH = 0.1f;
...
static const float GB_THRESHOLD = 0.0f; // interpolation time
static const float GB_THRESHOLD2 = 0.8f; // interpolation time
