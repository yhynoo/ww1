...
NCountry = {
	...
	WAR_SUPPORT_TENSION_IMPACT = 0.5,				-- [MOD; vanilla had 0.4] Total impact of world tension
	MIN_STABILITY = 0.0,
	MAX_STABILITY = 1.0,
	MIN_WAR_SUPPORT = 0.0,
	MAX_WAR_SUPPORT = 1.0,
	...
	BASE_SURRENDER_LIMIT = 0.8,						-- [MOD; vanilla had 0.8] Base level of occupation required for country surrender
	...
	BOMBING_WAR_SUPPORT_PENALTY_SCALE = -0.0015, 			-- [MOD; vanilla had -0.00015] Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
...
NBuildings = {
	...
	AIRBASE_CAPACITY_MULT = 100,		-- MOD; Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
