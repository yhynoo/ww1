...
NAI = {
	...
	DIPLOMATIC_ACTION_BREAK_SCORE = -20, 		-- [MOD; vanilla had -10] AI must score a diplomatic action less than this to break it off
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 10, -- [MOD; vanilla had 60] AI penalty for diplomatic faction acitons between nations of different ideologies
	...
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 10,	-- [MOD; vanilla had 50] Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
	...
	DIPLO_DISTANCE_BETWEEN_CAPITALS = -100,		-- [MOD; vanilla had -340] Max scaled malus from distance between capitals
